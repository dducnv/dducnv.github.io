            ...
            <div className="flex flex-col gap-2 pt-2 animate mb-4">
              ...
              <div className="text-sm font-medium text-gray-500 mt-3 animate">
                ...
                <div className="flex flex-wrap items-center gap-2 mt-2">
                  ...
                  <span className="text-gray-300">/</span>
                  <a href="https://apps.apple.com/vn/app/tessera-block-puzzle-game/id6758011076" className="hover:text-gray-600 transition-colors flex items-center gap-1 group">

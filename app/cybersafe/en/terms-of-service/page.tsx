  ...
  return (
    <div className="max-w-3xl mx-auto prose lg:prose-xl pt-10 px-5">
      ...
      <div className="section animate">
        ...
        <p>CyberSafe may integrate with third-party services such as Google Drive to enable backup and restore functionality. Your use of Google Drive is subject to the <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline">Google Privacy Policy</a> and other applicable Google terms. We encourage you to review these policies carefully before using such services.</p>
      </div>
